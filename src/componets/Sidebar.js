            ...
            <div className="side-container">
                <div className="side-content">
                    ...
                    <ul>
                        ...
                        <li>
                        <div className="sidebar">
                           <Link to="/moviecart" style={{color:"white",textDecoration:"none"}}>
                        ...
                        <div className="sidebar">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-chevron-bar-expand" viewBox="0 0 16 16">
